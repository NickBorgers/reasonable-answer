...
The change has been quick and close to universal. Maintenance-first working of the kind described above became the ordinary condition of widely used open source within about three years of sponsorship arriving, unsponsored feature-first volunteer maintenance is now rare at that tier of usage, and the turnover ran faster than any earlier shift in how this work was paid for [3][4]. That is why the differences above should be read as a description of the ecosystem rather than of a corner of it: if sponsorship is now the normal case, the maintainers describing it are the normal case too.
