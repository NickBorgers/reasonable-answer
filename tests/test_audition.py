...
def test_severity_agreement_is_a_rate_over_a_whole_audition():
    ...
    def respond(alias, user):
        ...
        if framing in user:
            # The doctrine-compliant minor reading. It is not a detection, and before
            # D-minor-floor-fixtures it incremented the numerator anyway.
            return [
                issue(Category.LOADED_LANGUAGE, 2, 1, Severity.MINOR, claim_span=framing)
            ]
        return []
