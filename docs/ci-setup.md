...
|---|---|---|---|
| `invariant` reviewer | claude | `claude-opus-5-5` | never-abstain backstop on the six invariants and the merge gate |
...
| issue author, fixer | per agent | `gpt-5.6-sol` / `claude-opus-5-5` | open-ended work across a whole repository |
