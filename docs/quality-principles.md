...
| QP3 | **The CI panel itself stays family-diverse.** Reviewer roles split across at least two agent families, and a role sits cross-family from the role it primarily deconflicts with. | `agent:` inputs in `review-pipeline.yml` | Kim et al. 2025; Verga et al. 2024 |
