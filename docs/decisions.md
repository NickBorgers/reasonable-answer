...
**The measurement.** Three audits agreed, and the trend worsened as the measurement got more
honest. On 2026-08-02 (first run on the reshaped corpus, prompt-mode extraction) `minimax-m3`
