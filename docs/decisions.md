...
## D35 — a hung author-resume is contained at the container boundary, not by `continue-on-error`
...
- Detecting an *unresumable* author session before spending a resume attempt on it (D35, #85
