...
- Verifying `Cf-Access-Jwt-Assertion` against the team's JWKS with an `aud` check, replacing the
  trusted email header (D31). The prerequisite for exposing the service beyond a small invited
