...
class RevisionConfig(BaseModel):
    ...
    #: Gate 1 (marker-less body) and gate 2 (out-of-scope rewrite) each spend at most
    #: `repair.repair_cap` writer calls before the draft ships as-is (D-census-gated-repair).
