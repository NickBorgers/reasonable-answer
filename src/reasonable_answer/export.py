...
The deployment posture is tailnet-only and unauthenticated (see README), so sharing a
result means handing over a *file*, not a link. That constrains what an export has to
